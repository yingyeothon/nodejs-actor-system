...
exports.handleActorLambdaEvent = ({ newActorEnv, functionTimeout = defaultLambdaFunctionTimeoutMillis, logger: maybeLogger, aliveMode = "tryToProcess" }) => (event) => __awaiter(this, void 0, void 0, function* () {
